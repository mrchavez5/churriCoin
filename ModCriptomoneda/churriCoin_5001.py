...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  4 09:08:05 2021

@author: bjcdevelop
"""

#Modulo 2 - Criptomoneda
# Para instalar
...
# Crear la direccón del nodo en el puerto 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = "Churrita", amount = 10)
...
def connect_node():
    ...
    response = {'message': 'Todos los nodos han sido conectados. La cadena de churriCoins contiene ahora los nodos siguientes: ',
...
def replace_chain():
    ...
    if is_chain_replace:
        response = {'message': 'Los nodos tenían diferentes cadenas, que han sido reemplzadas por la más larga',
                    'new_chainge': blockchain.chain}
    else:
